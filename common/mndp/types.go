...
type Device struct {
	...
	Identity            string            // TLV type 5  — unique device identity key used in discovery/topology output
	...
	Interfaces          []InterfaceRecord // all observed interfaces for this identity
}
